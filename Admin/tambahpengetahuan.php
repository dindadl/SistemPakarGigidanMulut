...
if(isset($_POST['simpanbasis'])){
  $kode_gejala = $_POST['kode_gejala'];
  $kode_penyakit = $_POST['kode_penyakit'];


  if($kode_gejala && $kode_penyakit){ 
      $sql1 = "INSERT INTO tb_pengetahuan(kode_gejala,kode_penyakit) VALUES ('$kode_gejala','$kode_penyakit')";
      $q1 = mysqli_query($conn,$sql1);

      if($q1){
        $sukses ="Data berhasil ditambahkan.";
        echo"<meta http-equiv=refresh content=2;URL='admbasis.php'>";
      }else{
...
<li class="nav-item">
 ...
 <li class="nav-item">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <h1 class="h3 mb-0 text-gray-800">Tambah Pengetahuan</h1>
                        </div>
...
<option value="P06">P06</option>       
    ...
    <input type="submit" class="btn btn-primary" name="simpanbasis" value="Simpan Data">
