...
if(isset($_POST['simpanpenyakit'])){
  ...
  if($kode_penyakit && $nama_penyakit && $penyebab && $saran){ 
      $sql1 = "INSERT INTO tb_penyakit(kode_penyakit,nama_penyakit,penyebab,saran) VALUES ('$kode_penyakit','$nama_penyakit','$penyebab','$saran')";
...
<input type="text" class="form-control form-control-user" id="kode_penyakit"  name="kode_penyakit" placeholder="Kode Penyakit (P00)">
    <br>

<label>Nama Penyakit</label>
    <input type="text" class="form-control form-control-user" id="nama_penyakit" name="nama_penyakit" placeholder="Nama Penyakit">
    <br>

 <label>Penyebab</label>
<textarea class="form-control form-control-user" id="penyebab"  name="penyebab" placeholder="Penyebab" rows="3"></textarea>
    <br>

     <label>Saran</label>
<textarea class="form-control form-control-user" id="saran"  name="saran" rows="3" placeholder="Saran"></textarea>
    <br>
