...
if(isset($_POST['simpanrule'])){
  ...
  if($kode_gejala && $kode_penyakit){ 
      $sql1 = "INSERT INTO tb_rule(kode_penyakit,kode_gejala) VALUES ('$kode_penyakit','$kode_gejala')";
...
<body id="page-top">
 ...
 <li class="nav-item">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <h1 class="h3 mb-0 text-gray-800">Tambah Aturan</h1>
                        </div>
...
<option value="G018">G018</option>    
    ...
    <input type="submit" class="btn btn-primary" name="simpanrule" value="Simpan Data">
