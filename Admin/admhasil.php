...
<li class="nav-item">
 ...
 <li class="nav-item">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <h1 class="h3 mb-0 text-gray-800">Daftar Hasil Konsultasi</h1>
                  ...
                  <br>
                        ...
                        <?php
                          ...
                          $admin = mysqli_query($conn,"SELECT * FROM tb_hasil"); 
                                ...
                                $kode_penyakit = $row['kode_penyakit'];
                                 ...
                                 ?>
                                  <tr>
                                    ...
                                    <td>
                                        <a href="edithasil.php?editid=<?php echo $id ?>">

                                        <button type="button" class="btn btn-warning" name="edithasil">Update</button> </a>

                                   <a href="hapushasil.php?deleteid=<?php echo $id ?>" onclick="return confirmDelete();">  

                                    <button type="button" class="btn btn-danger" name="hapushasil">Hapus</button> </a>
