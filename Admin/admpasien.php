...
<li class="nav-item">
  ...
  <li class="nav-item">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <h1 class="h3 mb-0 text-gray-800">Daftar Data Pasien</h1>
                  ...
                  <br>
                        ...
                        <?php
                          ...
                          $admin = mysqli_query($conn,"SELECT * FROM tb_datapasien"); 
                                ...
                                $umur_user = $row['umur_user'];
                                 ...
                                 ?>
                                  <tr>
                                   ...
                                   <a href="hapuspasien.php?deleteid=<?php echo $id ?>" onclick="return confirmDelete();">  

                                    <button type="button" class="btn btn-danger" name="hapuspasien">Hapus</button> </a>
