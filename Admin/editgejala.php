...
$sukses ="";
 ...
 $id = $_GET['editid'];
 $sql1= "SELECT * FROM tb_gejala WHERE kode_gejala = '$id'";
...
if(isset($_POST['editgejala'])){
  $id = $_POST['kode_gejala'];
  $nama_gejala = $_POST['nama_gejala'];


  $sql = "UPDATE tb_gejala SET kode_gejala = '$id',nama_gejala = '$nama_gejala' WHERE kode_gejala = '$id' ";
...
<li class="nav-item">
 ...
 <li class="nav-item">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <h1 class="h3 mb-0 text-gray-800">Update Data Gejala</h1>
...
<input type="text" class="form-control form-control-user" id="kode_gejala"  name="kode_gejala" placeholder="Kode Gejala (G000)" value= <?php echo $id;?>>
    <br>

<label>Nama Gejala</label>
    <input type="text" class="form-control form-control-user" id="nama_gejala" name="nama_gejala" placeholder="Nama Gejala" value= <?php echo $nama_gejala;?> >
    <br>
