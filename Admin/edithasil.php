...
$sukses ="";
 ...
 $id = $_GET['editid'];
 $sql1= "SELECT * FROM tb_hasil WHERE id_hasil= $id";
...
if(isset($_POST['edithasil'])){
  ...
  $sql = "UPDATE tb_hasil SET id_hasil = $id_hasil,id_pasien = '$id_pasien',,kode_penyakit = '$kode_penyakit' , WHERE id_hasil = $id ";
  $q1 = mysqli_query($conn,$sql);

 if($q1){
        $sukses ="Data berhasil diupdate.";
        echo"<meta http-equiv=refresh content=1;URL='admrule.php'>";
...
<li class="nav-item">
 ...
 <li class="nav-item">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <h1 class="h3 mb-0 text-gray-800">Update Hasil Konsultasi</h1>
                        </div>
...
<input type="text" class="form-control form-control-user" value= <?php echo $id_pasien;?> >
 <br>
