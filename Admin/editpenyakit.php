...
$sukses ="";
 ...
 $id = $_GET['editid'];
 $sql1= "SELECT * FROM tb_penyakit WHERE kode_penyakit = '$id'";
...
if(isset($_POST['editpenyakit'])){
  ...
  $saran = $_POST['saran'];
   ...
   $sql = "UPDATE tb_penyakit SET kode_penyakit = '$id',nama_penyakit = '$nama_penyakit', penyebab = '$penyebab', saran = '$saran' WHERE kode_penyakit = '$id' ";
  $q1 = mysqli_query($conn,$sql);

 if($q1){
        $sukses ="Data berhasil diupdate.";
        echo"<meta http-equiv=refresh content=1;URL='admdaftarpenyakit.php'>";
...
<input type="text" class="form-control form-control-user" id="kode_penyakit"  name="kode_penyakit" placeholder="Kode Penyakit (P00)" value= <?php echo $id;?> >
    <br>

<label>Nama Penyakit</label>
    <input type="text" class="form-control form-control-user" id="nama_penyakit" name="nama_penyakit" placeholder="Nama Penyakit" value= <?php echo $nama_penyakit;?> >
    <br>

 <label>Penyebab</label>
<textarea class="form-control form-control-user" id="penyebab"  name="penyebab" placeholder="Penyebab" rows="3" ><?php echo $penyebab;?></textarea>
    <br>

     <label>Saran</label>
<textarea class="form-control form-control-user" id="saran"  name="saran" rows="3" placeholder="Saran"> <?php echo $saran;?> </textarea>
    <br>

    <input type="submit" class="btn btn-primary" name="simpanpenyakit" value="Simpan Data">
