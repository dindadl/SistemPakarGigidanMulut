...
$sukses ="";
 ...
 $id = $_GET['editid'];
 $sql1= "SELECT * FROM tb_admin WHERE id_admin= $id";
...
if(isset($_POST['updateadmin'])){
  ...
  $sql = "UPDATE tb_admin SET id_admin= $id,username = '$username' ,password = '$password' WHERE id_admin = $id ";
  $q1 = mysqli_query($conn,$sql);

 if($q1){
        $sukses ="Data berhasil diupdate.";
        echo"<meta http-equiv=refresh content=2;URL='admadmin.php'>";
...
<label>Password</label>
    <input type="text" class="form-control form-control-user" id="password" name="password" placeholder="Password" value= <?php echo $password;?>>
    <br>

    <input type="submit" class="btn btn-primary" name="updateadmin" value="Update Data">
