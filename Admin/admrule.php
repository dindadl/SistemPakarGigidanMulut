            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Daftar Aturan</h1>
                        
                    </div>

                   <button onclick="location.href='tambahrule.php'" type="button" class="btn btn-primary" name="tambahrul"> + Tambah Data Aturan </button>
                  <br>
                  <br>
                        ...
                        <?php
                          ...
                          $rule = mysqli_query($conn,"SELECT * FROM tb_rule"); 
                          while($row = mysqli_fetch_array($rule))
                          {
                                $id = $row['id_rule'];
                                ...
                                $kode_penyakit = $row['kode_penyakit'];
                                 ...
                                 ?>
                                  <tr>
                                    ...
                                    <td>
                                        <a href="editrule.php?editid=<?php echo $id?>">

                                        <button type="button" class="btn btn-warning" name="editrule">Update</button> </a>

                                         <a href="hapusrule.php?deleteid=<?php echo $id ?>"onclick="return confirmDelete();"> 
