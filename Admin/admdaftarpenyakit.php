 ...
 <li class="nav-item">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <h1 class="h3 mb-0 text-gray-800">Daftar Penyakit</h1>
                         ...
                         <button onclick="location.href='tambahpenyakit.php'" type="button" class="btn btn-primary" name="tambahadmin"> + Tambah Data Penyakit </button>
                  <br>
                  <br>
                        ...
                        <?php
                          include '../config.php';
                          $penyakit = mysqli_query($conn,"SELECT * FROM tb_penyakit");
                                ...
                                $saran = $row['saran'];
                                 ...
                                 ?>
                                  <tr>
                                    ...
                                    <td>
                                        <a href="editpenyakit.php?editid=<?php echo $id ?>">

                                            <button type="button" class="btn btn-warning" name="editpenyakit">Update</button> </a>

                                             <a href="hapuspenyakit.php?deleteid=<?php echo $id ?>"onclick="return confirmDelete();">

                                    <button type="button" class="btn btn-danger" name="hapuspenyakit">Hapus</button></a>
                                    </td>
                                     </tr>
                                     <?php
                         }
