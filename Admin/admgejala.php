...
<li class="nav-item">
 ...
 <li class="nav-item">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <h1 class="h3 mb-0 text-gray-800">Daftar Gejala Penyakit</h1>
                        
                       
                        
                        </div>
                         <button onclick="location.href='tambahgejala.php'" type="button" class="btn btn-primary" name="tambahgejala"> + Tambah Data Gejala </button>
                  <br>
                  <br>
                        ...
                        <?php
                          include '../config.php';
                          $gejala = mysqli_query($conn,"SELECT * FROM tb_gejala");
                                ...
                                $nama_gejala = $row['nama_gejala'];
                                 ...
                                 ?>
                                  <tr>
                                    ...
                                    <td>
                                     <a href="editgejala.php?editid=<?php echo $id ?>">

                                   <button type="button" class="btn btn-warning" name="editgejala">Update</button></a>

                                        <a href="hapusgejala.php?deleteid=<?php echo $id ?>"onclick="return confirmDelete();">

                                    <button type="button" class="btn btn-danger" name="hapusgejala">Hapus</button>
                                    </td>
                                     </tr>
                                     <?php
                         }
