...
<li class="nav-item">
 ...
 <li class="nav-item">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <h1 class="h3 mb-0 text-gray-800">Daftar Basis Pengetahuan</h1>
                        ...
                        <!-- Earnings (Monthly) Card Example -->
                         ...
                         <button onclick="location.href='tambahpengetahuan.php'" type="button" class="btn btn-primary" name="tambahbasis"> + Tambah Data Pengetahuan </button>
                  <br>
                  <br>
                        ...
                        <?php
                          ...
                          $admin = mysqli_query($conn,"SELECT * FROM tb_pengetahuan"); 
                          while($row = mysqli_fetch_array($admin)) 
                          {
                                $id = $row['id_pengetahuan'];
                                ...
                                $kode_penyakit = $row['kode_penyakit'];
                                 ...
                                 ?>
                                  <tr>
                                    ...
                                    <td>
                                        <a href="editbasis.php?editid=<?php echo $id ?>">
                                            
                                        <button type="button" class="btn btn-warning" name="editbasis">Update</button> </a>
                                       
                                        <a href="hapusbasis.php?deleteid=<?php echo $id ?>"onclick="return confirmDelete();">  

                                    <button type="button" class="btn btn-danger" name="editadmin">Hapus</button>
                                    </td>
                                     </tr>
                                     <?php
                         }
